...
import AppDropzone from '../../app/common/AppDropzone';
import AppTextInput from '../../app/common/AppTextInput';
import AppSelectList from '../../app/common/AppSelectList';
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12}>
                        <Box display="flex" justifyContent="space-between" alignItems="center">
                            ...
                            {watchFile ? <img src={watchFile.preview} alt="preview" style={{ maxHeight: 200 }} /> : <img src={product?.pictureUrl} alt={product?.name} style={{ maxHeight: 200 }} />}
                        </Box>
                    </Grid>
                </Grid>
