...
export default function SubCategory() {
  return <Paper sx={{ minWidth: "10rem", height: "15rem", display: 'flex', flexDirection: 'column', cursor: 'pointer', marginRight: '1rem', textDecoration: 'none' }} component={Link} to="/category/laptop">
